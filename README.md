...
- Which retailers contribute most to revenue and margin?  
- How do sales methods (in‑store, online, outlet) perform relative to each other?  
- Which regions and states are driving overall performance?
...
- **Sales Method Breakdown**  
  Pie chart visualizing the percentage of sales by method (in‑store, online, outlet).

- **Retailer Performance**  
  Horizontal bar chart ranking major retailers (West Gear, Walmart, Sports Direct, Kohl’s, Foot Locker, Amazon) by sales and profit.

- **Sales Trend by Quarter**  
  Line chart tracking quarterly sales to identify growth and seasonality between 2020 and 2021.

- **Regional Sales Map**  
  Filled US map showing operating profit by state, with slicers for city, state, and other filters.
...
- Interactive controls using slicers for year, region, product, and retailer.
...
## Dashboard
<img width="1374" height="495" alt="Screenshot 2025-12-11 at 12 43 39 AM" src="https://github.com/user-attachments/assets/b0c2d9e2-b778-460e-b9f5-00b53c739668" />
